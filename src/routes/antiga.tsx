...
export const Route = createFileRoute("/antiga")({
  component: Index,
});
      ...
      <main className="cv-main">
        ...
        <div className="rise">
          ...
          <div className="linhas landing">
            <a className="linha glass" href="https://lp.conversoo.cloud/" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/conversoo.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">Conversoo — Site Institucional</div></div></a>
            <a className="linha glass" href="https://afonte.conversoo.cloud" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/afonte.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">A Fonte</div><div className="rl">Estudo bíblico guiado via WhatsApp e web</div></div><span className="badge b-beta">BETA</span></a>
            <a className="linha glass" href="https://cb-advocacia.vercel.app/" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/cbadv.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">CB Advocacia</div><div className="rl">Landing page e copy para escritório de advocacia bancária</div></div><span className="badge b-case">CASE</span></a>
            <a className="linha glass" href="https://lp-rafaelm.vercel.app/" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/rafael.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">Rafael Mendes — Clínica Postural</div><div className="rl">Clínica de quiropraxia e terapias manuais</div></div><span className="badge b-case">CASE</span></a>
            <a className="linha glass" href="https://lp-michele.netlify.app/" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/penteados.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">Curso de Penteados</div><div className="rl">Página de venda para curso de penteados</div></div><span className="badge b-case">CASE</span></a>
            <a className="linha glass" href="https://marcato-chi.vercel.app/" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/marcato.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">Marcato Studio</div></div><span className="badge b-case">CASE</span></a>
            <a className="linha glass" href="https://www.draadrinebetat.com.br/" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/adrine.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">Dra. Adrine Betat</div><div className="rl">Médica — atendimento individualizado e prevenção</div></div><span className="badge b-case">CASE</span></a>
          </div>
        </div>
        ...
        <div className="rise">
          ...
          <div className="agentes">
            <a className="agente glass" href="https://conversoo-grow-page.lovable.app" target="_blank" rel="noreferrer">
              ...
              <div><div className="nm">Lia</div><div className="rl">Atendimento e diagnóstico comercial</div></div>
            </a>
            <a className="agente glass" href="https://glam-glow-gate.lovable.app" target="_blank" rel="noreferrer">
              ...
              <div><div className="nm">Luna</div><div className="rl">Agendamento e atendimento</div></div>
            </a>
            <a className="agente glass" href="https://catalogo.aromasamore.com.br" target="_blank" rel="noreferrer">
              ...
              <div><div className="nm">Pã</div><div className="rl">Vendas e relacionamento, centenas de leads/semana</div></div>
            </a>
          </div>
        </div>
        ...
        <div className="rise">
          ...
          <div className="linhas">
            <a className="linha glass" href={WPP} target="_blank" rel="noreferrer"><div className="em" style={{ background: "rgba(16,185,129,.1)", border: "1px solid rgba(16,185,129,.24)" }}><svg width="18" height="18" viewBox="0 0 24 24" fill="#6ee7b7"><path d="M20.52 3.48A11.85 11.85 0 0 0 12.05 0C5.5 0 .17 5.33.17 11.88c0 2.09.55 4.13 1.6 5.93L0 24l6.34-1.66a11.86 11.86 0 0 0 5.7 1.45h.01c6.55 0 11.88-5.33 11.88-11.88 0-3.17-1.23-6.15-3.41-8.43zM12.05 21.5a9.6 9.6 0 0 1-4.9-1.34l-.35-.21-3.76.99 1-3.66-.23-.38a9.6 9.6 0 1 1 8.24 4.6z" /></svg></div><div className="nm">Falar no WhatsApp</div></a>
...
/* Único sistema de badge. Eixo semântico fechado de status: LIVE, BETA, ENCERRADO, CASE.
   Uma cor por variante, definida só aqui (nada de cor inline por item). */
