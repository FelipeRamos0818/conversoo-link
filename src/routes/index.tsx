      ...
      <main className="cv-main">
        ...
        <div className="rise">
          ...
          <div className="linhas landing">
            <a className="linha glass" href="https://lp.conversoo.cloud/" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/conversoo.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">Conversoo — Site Institucional</div></div><span className="tg" style={{ background: "rgba(124,58,237,.2)", border: "1px solid rgba(167,139,250,.5)", color: "#d6c9ff" }}>CONVERSOO</span></a>
