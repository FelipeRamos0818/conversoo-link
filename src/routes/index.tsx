      ...
      <main className="cv-main">
        ...
        <div className="rise">
          ...
          <div className="linhas landing">
            <a className="linha glass" href="https://lp.conversoo.cloud/" target="_blank" rel="noreferrer"><div className="em"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#93c5fd" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M5 19l3-3M14 6c4 0 4 4 4 4s-4 4-8 4l-2-2c0-4 4-6 6-6z" fill="rgba(147,197,253,.12)" /><circle cx="14.5" cy="9.5" r="1" /></svg></div><div className="txt"><div className="nm">Conversoo — Site Institucional</div></div><span className="tg" style={{ background: "rgba(124,58,237,.2)", border: "1px solid rgba(167,139,250,.5)", color: "#d6c9ff" }}>CONVERSOO</span></a>
