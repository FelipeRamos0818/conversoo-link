      ...
      <main className="cv-main">
        ...
        <div className="rise">
          ...
          <div className="linhas landing">
            ...
            <a className="linha glass" href="https://cb-advocacia.netlify.app" target="_blank" rel="noreferrer"><span className="em"><img src="/prev/cbadv.webp" alt="" loading="lazy" width="44" height="44" /></span><div className="txt"><div className="nm">CB Advocacia</div><div className="rl">Landing page e copy para escritório de advocacia bancária</div></div><span className="badge b-case">CASE</span></a>
